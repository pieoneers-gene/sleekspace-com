        ...
        <div id="content" class="site-content">
            <div class="page-header dtable text-center header-transparent pheader-contact">
                <div class="dcell">
                    <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6 align-self-center mb-5 mb-lg-0">
                        <div class="contact-left">
                            <h2>Get in Touch</h2>
                            <p class="font14">Message Sent!*</p>
                            <form  action="https://sleekspace.design/index.php/welcome/email" method="post" class="wpcf7">
                                <div class="main-form">
                                    <p>
                    ...
                    <div class="col-lg-6">
                        <div class="contact-right">
                            ...
                            <div class="contact-info">
                                ...
                                <div class="info-text">
                                    <h6>OUR ADDRESS:</h6>
                                    <p>Snohomish, WA, Washington,United States.</p>
                                </div>
                            </div>
                            <div class="contact-info">
                                ...
                                <div class="info-text">
                                    <h6>OUR MAILBOX:</h6>
                                    <p><a href="mailto:info@sleekspace.design">info@sleekspace.design</a></p>
                                </div>
                            </div>
                            <div class="contact-info">
                                ...
                                <div class="info-text">
                                    <h6>OUR PHONE:</h6>
                                    <p><a href="tel:+12538310610">952 217 6739</a></p>
                                </div>
                            </div>
